...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    // find the first element and the matching API key
    ...
    // promise all handles multiple request at the same time/simultaneously
    ...
    // return to the request made as response
